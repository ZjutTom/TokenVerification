package com.myhexin.tokenverification.interceptor;
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                // 获取 token 中的 user id
                String userId;
                String createTimeMillisString;
                try {
                    userId = JWT.decode(token).getAudience().get(0);
                    createTimeMillisString = JWT.decode(token).getAudience().get(1);
                ...
                long createTimeMillis = Long.parseLong(createTimeMillisString);
                if(currentTimeMillis - createTimeMillis > 1000 * 60) {
